...
def generate_launch_description():
    ...
    os.environ["GZ_SIM_RESOURCE_PATH"] = (
        ...
        + f":{os.path.join(get_package_share_directory('restaurant'), 'models')}"
    )
            ...
            IncludeLaunchDescription(
                ...
                launch_arguments=[
                    (
                        ...
                        "-r "
                        + os.path.join(
                            get_package_share_directory("restaurant"),
                            "world",
                            "restaurant.sdf",
                        ),
                    )
